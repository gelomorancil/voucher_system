    ...
    return (
        <div className="w-full min-h-[60dvh]">
            <table className="min-w-full table-fixed border-collapse rounded-lg">
                <thead>
                    <tr className="bg-slate-50 text-left text-gray-600 font-normal">
                ...
                <tbody>
                    {parent.length === 0 ? (
                        ...
                        parent.map((parent) => {
                            const remaining =
                                parent.qty -
                                (parent.buy_count + parent.claimed_count);
                            return (
                                <tr key={parent.id} className="border-b">
                                    ...
                                    <td className="py-2 hover:cursor-pointer">
                                        <div className="flex gap-2">
                                            <button
                                                className="icons border border-gray-100 shadow-sm hover:bg-gray-200 w-10 h-10 justify-center items-center flex rounded-md text-primary-500"
                                                onClick={() =>
                                                    window.open(
                                                        route(
                                                            "voucher.show",
